# BaseCMS Websites for Bonhill Group
This monorepo contains the codebase for websites managed by Bonhill Group. All sites within this repository utilize the [@parameter1/base-cms](https://github.com/parameter1/base-cms) packages, most notably the `marko-web` and `web-cli`.
